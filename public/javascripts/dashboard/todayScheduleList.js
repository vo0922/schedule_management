...
/**
 * 담당자 : 이승현
 * 함수 설명 : 사용자가 오늘일정 요소를 드래그하려고 시작할 때 발생하는 함수
 * 주요 기능 : drag가 시작됨을 알리는 효과인 dragging class를 추가하고, 드래그 요소의 데이터를 설정합니다.
 */
...
/**
 * 담당자 : 이승현
 * 함수 설명 : 사용자가 오늘일정 요소를 드래그하다가 마우스 버튼을 놓는 순간 발생하는 함수
